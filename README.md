# ZoneBuilder (Unofficial)

Old fork from ZoneBuilder : A level editor for SRB2, forked from GZDoom Builder.

https://git.magicalgirl.moe/MascaraSnake/ZoneBuilder

This version was only tested and designed for SRB2 Kart.

SRB2 2.2 may work except flat alignment, add `newflatalignment = true;` into 2.2 config for new flat alignment to work.

*Current: v2.10.0.2506*

Worked over the source code from v2.9 tag so official commits after that are missing. (I might look into it when get free time)
...
Note that currently I don't have much free time to work on this project so don't ask me to continue MascaraSnake work.
...
• Added missing sector type "Invert Encore Remap" and linedef trigger "Encore Load".
